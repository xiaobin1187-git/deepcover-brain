...
public class MybatisPlusGenerator {
    ...
    private static String DB_URL = "jdbc:mysql://YOUR_MYSQL_HOST:3306/YOUR_DATABASE?useUnicode=true&characterEncoding=utf8";
    private static String DB_DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    private static String DB_USERNAME = "YOUR_DB_USERNAME";
    private static String DB_PASSWORD = "YOUR_DB_PASSWORD";

    private static String DB_URL2 = "jdbc:mysql://YOUR_MYSQL_HOST:3306/YOUR_DATABASE?useSSL=false";
    private static String DB_DRIVER_NAME2 = "com.mysql.cj.jdbc.Driver";
    private static String DB_USERNAME2 = "YOUR_DB_USERNAME";
    private static String DB_PASSWORD2 = "YOUR_DB_PASSWORD";
