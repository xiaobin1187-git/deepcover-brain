...
- Main class: `com.timevale.aresbrain.deploy.Application`
...
- Mapper scan base package: `com.timevale.aresbrain.dal`
...
- Follow existing mapper patterns in `dal/src/main/java/com/timevale/aresbrain/dal/mapper/`
- Entities are in `dal/src/main/java/com/timevale/aresbrain/dal/entity/`
...
- Controllers should be placed in `service/src/main/java/com/timevale/aresbrain/service/controller/`
...
### Adding New Services
- Service interfaces go in `service/src/main/java/com/timevale/aresbrain/service/service/`
- Implementations go in `service/src/main/java/com/timevale/aresbrain/service/service/impl/`
