...
public class DingNotifyUtils {
    ...
    public void sendMsg(String access_token, String username, String action, String param) {
        ...
        String jsonStr = "{\n" +
                ...
                "    \"markdown\": {\n" +
                "        \"title\": \"GTR\",\n" +
                "        \"text\": \"#### **<font color=#BB5500 >【GTR平台操作监控】</font>**\\n> ###### 压测操作：" + action + "\\n> ###### 操作环境:VPC模拟环境 \\n> ######  压测任务名 ：" + par + "\\n> ######  压测执行人 ：" + username + "\\n> ###### 详见 [GTR平台系统日志](http://YOUR_GTR_HOST/gtr/index.html#modules/sys/log.html)\\n\"\n" +
                "    },\n" +
                "    \"at\": {\n" +
                "        \"atMobiles\": [\n" +
                "            \"YOUR_NOTIFY_PHONE\"\n" +
    ...
    public static void feedMsg(Map<String, Object> params) {
        ...
        sb.append("> - 时间：").append(sdf.format(new Date())).append(enter)
                .append("> ###### 数据来源：[GTR性能压测平台]").append("(http://YOUR_GTR_HOST/gtr/index.html)").append(enter);
...
//                + "\\n 分析完成时间: " + startTime + "\\n 环境类型: " + stopTime + "\\n 变更分支：" + status +"\\n 操作环境：模拟环境 \\n 压测脚本名：" + taskName + "\\n 触发人：" + usr + "\\n 压测报告Id: " + reportId + "\\n 详情查看：" + reportUrl + "\\n\",\n" +
    ...
    public static void main(String[] args) {
        // Test entry point - removed hardcoded credentials
    }
}
