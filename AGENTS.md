...
### Controller Layer (`service/src/main/java/com/timevale/aresbrain/service/controller/`)
...
### Service Layer (`service/src/main/java/com/timevale/aresbrain/service/service/`)
...
### Data Access Layer (`dal/src/main/java/com/timevale/aresbrain/dal/`)
...
- Mapper scan: `com.timevale.aresbrain.dal`
